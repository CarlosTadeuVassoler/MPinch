...
def acima(nhot,ncold,n,nstages,correntestrocador,pinchq,pinchf,dlg,nlinhas):
...
def adicionaracima():
	global Fharr,Fcarr,Q,Qtotalh0,Qtotalc0,Thski,Thskf,Tcski,Tcskf,Tcki,Tckf,Thki,Thkf,Qaux,Qtotalhaux,Qtotalcaux,Qtotalestagiof,Qtotalestagioq,Qtotalestagio,Thin,Thout,Think,Thoutk,Tcink,Tcoutk,Thfinal01,Thfinal01k,Tcfinal01,Tcfinal01k,tempdif
	cont = 0
...
def variaveis1():
	global Qtotalh0,Qtotalc0,Q,Fharr,Fcarr,Tcski
