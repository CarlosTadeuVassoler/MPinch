...
def acima(correntesncorrigidas,correntestrocador,ntrocadores,pinchq,pinchf,n,nhot,ncold,dlg,dTmin,chot,ccold,nlinhas,opcao,Qtabela0):
	...
	print("Thf e Th0",Thf,Th0)
	
	print("correntestrocador",correntestrocador,Tc0,Thf)
	...
	map(float, Qtotalh01)
	map(float, Qtotalc01)
	print("Qtotalh0 no começo",Qtotalh0)
	...
	print("Preench. matrizes",nlinhas)
	if nlinhas >= 2:
	...
	if opcao == 3:
		...
		if dlg.radioButton_4.isChecked():   #MAXIMUM HEAT
			...
			print("Qmax?",Q[chot-1][sbhot-1][ccold-1][sbcold-1][sestagio-1][estagio-1])
		    ...
		    if Q[chot-1][sbhot-1][ccold-1][sbcold-1][sestagio-1][estagio-1] > Qmax:
		        ...
		        return
		    print("Heat load",Q[chot-1][sbhot-1][ccold-1][sbcold-1][sestagio-1][estagio-1])
	...
	if opcao == 4:
		...
		print("Números",chot,ccold,sbhot,sbcold,estagio,sestagio)
		...
		print("Thout e Tcout",Thout,Tcout)
