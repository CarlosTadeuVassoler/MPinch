...
def testar_correntes_abaixo():
	...
	if somaCPc >= somaCPh:
		print('BELOW A somatória dos CPs das correntes frias é maior que a somatória dos CPs das correntes quentes!')
